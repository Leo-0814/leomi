...
```ts
import { useCreatePublicMovieList, useGetMyPrivateMovieLists, useAddMovieToList, useDeleteMyReview } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useDeleteMyReview(deleteMyReviewVars);
...
```js
import { createPublicMovieList, getMyPrivateMovieLists, addMovieToList, deleteMyReview } from '@dataconnect/generated';
...
// Operation DeleteMyReview:  For variables, look at type DeleteMyReviewVars in ../index.d.ts
